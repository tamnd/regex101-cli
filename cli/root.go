// Package cli builds the regex101 command tree on top of the regex101 library.
package cli
...
func Root() *cobra.Command {
	app := &App{cfg: regex101.DefaultConfig()}

	root := &cobra.Command{
		Use:           "regex101",
		Short:         "Browse regex patterns from the regex101.com library",
		SilenceUsage:  true,
		SilenceErrors: true,
...
func (a *App) setup() error {
	...
	a.client = regex101.NewClient(a.cfg)
	return nil
}
