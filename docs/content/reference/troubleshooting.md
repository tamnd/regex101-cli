...
Most of these come down to network reality or how regex101 serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

regex101 rate-limits like any public site. regex101 already paces
...
Where a surface is gated, regex101 reads a cookie or token you supply
...
`regex101`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what regex101 actually did
